...
router.get('/pending', authorization.reviewer, (req, res) => breedingController.getPendingBreedings(req, res));
...
router.put('/accept/:id', authorization.reviewer, (req, res) => breedingController.acceptBreeding(req, res));
router.put('/reject/:id', authorization.reviewer, (req, res) => breedingController.rejectBreeding(req, res));
