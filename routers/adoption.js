...
router.get('/pending', authorization.reviewer, (req, res) =>adoptionController.getPendingAdoptions(req, res));
...
router.put('/accept/:id', authorization.reviewer, (req, res) =>adoptionController.acceptAdoption(req, res));
router.put('/reject/:id', authorization.reviewer, (req, res) =>adoptionController.rejectAdoption(req, res));
