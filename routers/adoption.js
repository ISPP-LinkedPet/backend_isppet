...
router.get('/offers', authorization.shelter_particular, (req, res) =>
  adoptionController.getAdoptionsOffers(req, res),
);
...
router.post('/interested/:id', authorization.particular, (req, res) =>
  adoptionController.imInterested(req, res),
);
router.post('/', authorization.shelter_particular, (req, res) =>
  adoptionController.createAdoption(req, res),
);
router.put('/edit/:id', authorization.shelter_particular, (req, res) =>
...
router.put('/accept/:id', authorization.moderator, (req, res) =>
  adoptionController.acceptAdoption(req, res),
);
router.put('/reject/:id', authorization.moderator, (req, res) =>
  adoptionController.rejectAdoption(req, res),
);
