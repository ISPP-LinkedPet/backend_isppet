...
router.delete('/delete/:id', authorization.particular, (req, res) => petController.deletePet(req, res));
...
router.get('/canDelete/:id', authorization.particular, (req, res) => petController.getCanDelete(req, res));
